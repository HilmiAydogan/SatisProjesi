    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 5, CategoryId = 2,ImageUrl="/images/5.jpg", ProductName = "Deck", Price = 10_500, ShowCase=false},
                ...
                new Product() { ProductId = 8, CategoryId = 1,ImageUrl="/images/8.jpg", ProductName = "Kizil", Price = 900, ShowCase=false},
                new Product() { ProductId = 9, CategoryId = 2,ImageUrl="/images/9.jpg", ProductName = "Laptop", Price = 50, ShowCase=false},
                new Product() { ProductId = 10, CategoryId = 1,ImageUrl="/images/10.jpg", ProductName = "Makine", Price = 1000, ShowCase=false}
            );
        }
    }
}